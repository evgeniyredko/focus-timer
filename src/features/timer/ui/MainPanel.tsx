    ...
    <div className="bg-white text-black dark:bg-black dark:text-white w-full max-w-225 m-auto">
      <div className="mx-auto px-4 py-6 min-h-screen flex flex-col">
        ...
        <header className="shrink-0 flex items-center justify-between">
          ...
          <MenuIcon className="h-10 w-10 text-black dark:text-white cursor-pointer hover:text-accent hover:scale-110 transition duration-300" onClick={() => dispatch(openSettings())} />
        </header>
        ...
        <main className='flex-1 min-h-0 flex'>
          ...
          <section className=" font-black flex justify-center items-center [@media_(max-width:389px)]:justify-between -mt-2">
            <MinusIcon className="h-10 w-10 text-black dark:text-white mt-3 cursor-pointer hover:text-accent select-none hover:scale-110 transition duration-300" onClick={() => dispatch(decCurrentPhaseMinutesThunk())} />
            <div className="w-fit text-center text-7xl mx-7 [@media_(max-width:389px)]:mx-0">{formattedTime}</div>
            <PlusIcon className="h-10 w-10 text-black dark:text-white mt-3 cursor-pointer hover:text-accent select-none hover:scale-110 transition duration-300" onClick={() => dispatch(incCurrentPhaseMinutesThunk())} />
          </section>
