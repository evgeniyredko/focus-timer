  ...
  return (
    <div className="bg-white text-black dark:bg-black dark:text-white w-full max-w-225 m-auto">
      <div className="mx-auto px-4 py-6 min-h-screen flex flex-col">
        ...
        <button className="mt-auto mb-4 w-full rounded-2xl bg-white text-black pt-3 pb-4 text-2xl font-semibold dark:bg-black dark:text-white outline-2 cursor-pointer hover:bg-accent hover:scale-101 transition duration-300" onClick={() => dispatch(openConfirmResetStats())}>reset stats</button>
